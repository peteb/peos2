...
CXX=i686-elf-g++
AS=i686-elf-as
CFLAGS=-std=gnu99 -masm=intel -O3 -Wall -Wextra -fno-threadsafe-statics -DNDEBUG
CXXFLAGS=-std=c++17 -masm=intel -O3 -Wall -Wextra -fno-exceptions -fno-rtti -fno-threadsafe-statics -mno-red-zone -mgeneral-regs-only -I. -DNDEBUG
